...
export default function Footer() {
  return (
    <footer className="bg-[#020810] border-t border-white/5 text-gray-400">
      {/* Top wave */}
      <div className="bg-[#040c18] h-px w-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#C9A84C] to-[#fcd34d] 
                              flex items-center justify-center">
                <span className="text-[#0a1628] font-serif font-bold text-xl">B</span>
              </div>
              <div>
                <div className="text-white font-serif text-xl font-semibold">BMSCE</div>
                <div className="text-[#C9A84C] text-xs tracking-widest font-mono">EST. 1946</div>
              </div>
            </div>
              ...
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center
                             hover:border-[#C9A84C] hover:text-[#C9A84C] transition-all duration-300 hover:scale-110"
                >
                  <Icon size={15} />
                </a>
              ))}
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={href}>
                  <Link
                    to={href}
                    className="text-sm hover:text-[#C9A84C] transition-colors duration-200 hover:pl-1"
                  >
                    → {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="mt-8 p-4 rounded-xl border border-white/10 bg-white/3">
              <p className="text-xs text-[#C9A84C] font-mono tracking-wider mb-1">ACCREDITATION</p>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-xs">
            ...
            <a href="#" className="hover:text-[#C9A84C] transition-colors">RTI</a>
          </div>
        </div>
      </div>
    </footer>
